 ...
 * the filesystem in case of a blank or corrupt mempak after a repair is
 * attempted.
 *
 * @param[in] controller
...
//#endif
    ...
    // Label area would only required if the original content was not zeroed.
    // for (i = 0; i < 0 + 32; i ++)
    // {
    //     cpak_header_data[i] = 0x00;
    // }
