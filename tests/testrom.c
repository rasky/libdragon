...
static const struct Testsuite
{
	...
	TEST_FUNC(test_yuv_3p,                        0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_yuv_align,                     0, TEST_FLAGS_NO_BENCHMARK),
	TEST_FUNC(test_yuv_colorspace,                0, TEST_FLAGS_NO_BENCHMARK),
