...
libdragon.a: $(BUILD_DIR)/n64sys.o $(BUILD_DIR)/interrupt.o \
			 ...
			 $(BUILD_DIR)/audio/mixer.o $(BUILD_DIR)/audio/rsp_mixer.o \
			 $(BUILD_DIR)/audio/sfx64.o $(BUILD_DIR)/audio/xm64.o \
			 $(BUILD_DIR)/audio/libxm/context.o $(BUILD_DIR)/audio/libxm/load.o \
			 $(BUILD_DIR)/audio/libxm/play.o
	@echo "    [AR] $@"
	$(AR) -rcs -o $@ $^
...
install: libdragon.a libdragonsys.a
	...
	install -Cv -m 0644 include/sfx64.h $(INSTALLDIR)/mips64-elf/include/sfx64.h
